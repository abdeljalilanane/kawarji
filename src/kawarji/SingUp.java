...
public class SingUp extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setMinimumSize(new java.awt.Dimension(351, 650));
        getContentPane().setLayout(null);

        fond.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/sing.png"))); // NOI18N
        getContentPane().add(fond);
        fond.setBounds(0, 0, 350, 650);
